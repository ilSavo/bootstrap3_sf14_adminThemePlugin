...
[?php #include_partial('<?php echo $this->getModuleName() ?>/navbar', array('filter' => <?php echo $this->configuration->hasFilterForm() ? true : false ?>)) ?]
  ...
  <?php if ($this->configuration->hasFilterForm()): ?>
    ...
    <div class="alert alert-info alert-block">
      ...
      <h4 class="alert-heading">Filtri</h4>
      Questi risultati sono filtrati. <a href="#filterPopup" data-toggle="modal">Modifica i filtri</a>
    </div>
    [?php endif; ?]
  ...
  <div class="page-header">
    <div class="pull-right">
      <a href="#filterPopup" class="btn" data-toggle="modal"><i class="icon-search"></i> Cerca</a>
    </div>
